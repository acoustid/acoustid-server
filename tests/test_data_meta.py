...
def test_generate_meta_gid() -> None:
    ...
    assert uuid.UUID('781f130c-a3b4-5090-a87a-816c30bed2a5') == generate_meta_gid({'track': ''})
    assert uuid.UUID('454238f5-bceb-53c9-8a2c-029e79b86e26') == generate_meta_gid({'track': 'foo'})
    assert uuid.UUID('9c29eeb7-47d9-5364-935a-6a36b0f3bca0') == generate_meta_gid({'track': 'luk\xe1\u0161'})
    assert uuid.UUID('9acff514-86bf-5fcd-9253-03b8e91bc9ae') == generate_meta_gid({'track': 'foo', 'year': 1})

...
ALTER TABLE account_google ADD CONSTRAINT account_google_pkey PRIMARY KEY (google_user_id);
...
ALTER TABLE fingerprint_index_queue ADD;
...
ALTER TABLE mirror_queue ADD CONSTRAINT mirror_queue_pkey PRIMARY KEY (id);

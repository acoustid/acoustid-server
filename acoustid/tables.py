...
account = Table('account', metadata,
    ...
    Column('created', DateTime(timezone=True), server_default=sql.func.current_timestamp()),
...
application = Table('application', metadata,
    ...
    Column('apikey', String, nullable=False),
    Column('created', DateTime(timezone=True), server_default=sql.func.current_timestamp()),
    Column('active', Boolean, default=False, server_default=sql.true()),
    #Column('account_id', Integer, ForeignKey('account.id'), nullable=False),
    Column('account_id', Integer, nullable=False),
    Column('email', String),
...
track_mbid = Table('track_mbid', metadata,
    ...
    # FIXME Index('track_mbid_idx_uniq', 'track_id', 'mbid', unique=True),
    Index('track_mbid_idx_uniq', 'track_id', 'mbid'),
)
...
track_puid = Table('track_puid', metadata,
    ...
    Index('track_puid_idx_uniq', 'track_id', 'puid'),
)
...
track_meta = Table('track_meta', metadata,
    ...
    Column('created', DateTime(timezone=True), server_default=sql.func.current_timestamp()),
    Column('submission_count', Integer, nullable=False),
    #FIXMEIndex('track_meta_idx_uniq', 'track_id', 'meta', unique=True),
    Index('track_meta_idx_uniq', 'track_id', 'meta_id'),
)
...
track_foreignid = Table('track_foreignid', metadata,
    ...
    Index('track_foreignid_idx_uniq', 'track_id', 'foreignid_id'),
)

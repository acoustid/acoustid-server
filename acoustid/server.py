...
endpoints = {
    ...
    'v2.fingerprint': acoustid.api.v2.GetFingerprintHandler,
    'v2.track.list_by_mbid': acoustid.api.v2.TrackListByMBIDHandler,
    'v2.track.list_by_puid': acoustid.api.v2.TrackListByPUIDHandler,
    'v2.user.lookup': acoustid.api.v2.UserLookupHandler,
    'v2.user.create_anonymous': acoustid.api.v2.UserCreateAnonymousHandler,
    'v2.user.create_musicbrainz': acoustid.api.v2.UserCreateMusicBrainzHandler,
...
api_url_rules = [
    ...
    Submount('/v2', [
        ...
        Submount('/internal', [
            Rule('/update_lookup_stats', endpoint='v2.internal.update_lookup_stats'),
            Rule('/update_user_agent_stats', endpoint='v2.internal.update_user_agent_stats'),
            Rule('/lookup_stats', endpoint='v2.internal.lookup_stats'),
            Rule('/create_account', endpoint='v2.internal.create_account'),
            Rule('/create_application', endpoint='v2.internal.create_application'),
            Rule('/update_application_status', endpoint='v2.internal.update_application_status'),
            Rule('/check_application', endpoint='v2.internal.check_application'),
        ]),
    ]),
